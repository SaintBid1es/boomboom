...
public class Main {
       ...
       while(true) {
           ...
           switch (choise) {
               ...
               case 3:
                   ...
                   break;
               default:
                   System.out.print("Вы выбрали несуществующую функцию!");
           }
       }
        }
        public static void ChoiseBreakFast () {
            String Obeda;
    ...
    public void ExitJailBreak(){
        ...
        public void Info(){
        System.out.print("Вас зовут: Чарльз Бронсон\n Вы из : Великобритании\nВам 27 лет\nВас посадили за:ограбление почтового отделения ");
        }
        public void Bascetball(){
            System.out.print("Вы видите там 3 человек и предлагаете сыграть в стрит (Баскетбол на одно кольцо) \n Вдруг сокамерник говорит: Что на просто-так скучно играть и предлагает сыграть на пачку сигарет\nВы соглашаетесь\nИдет игра и вы с легкостью побеждаете,забрав награду.");
        }
        public void Vozdux(){
        System.out.print("Вы идете мимо баскетбольной площадки ,наслаждаясь прекрасным,свежым воздухом");
        }
        public void DrinkTea(){
        System.out.print("У вас есть на выбор чай,который вы хотите заварить:\n1.GreenFeald\n2.Пуэр\n3.Зеленый чай Матча\n4.Молочный улун\n5.Цейлонский чай\6.Earl Grey\n");
        ...
        System.out.print("У вас есть на выбор две койки : верхняя и нижняя\nВаши действия\n1.Лечь сверху\n2.Лечь снизу");
            ...
            if(koika==1)
                System.out.print("Вы легли спать на верхюю койку");
